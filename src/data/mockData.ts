...
export const mockData: ContentNode[] = [
  {
    ...
    summary: 'Comprehensive commentary and interpretation of the Holy Quran covering classical and contemporary approaches.',
    type: 'category',
    children: [
      {
        id: '1-1',
...
Understanding these foundational concepts is crucial for anyone seeking to study the Quran with proper guidance and scholarly rigor.`
              },
              {
                ...
                summary: 'Historical development of Quranic commentary through different eras',
                type: 'article',
...
These methods ensure accuracy and prevent misinterpretation while maintaining the sacred nature of the text.`
  ...
  },
  {
    ...
    summary: 'Comprehensive study of prophetic traditions and their interpretations in Islamic scholarship.',
    type: 'category',
    children: [
      {
        id: '2-1',
...
The authentication process involves multiple verification stages and cross-referencing with established biographical works, ensuring the highest standards of historical accuracy.`
      ...
      },
      {
        ...
        summary: 'Study of the six canonical collections and other important works',
        type: 'chapter',
        badge: 2,
        children: [
          {
  ...
  },
  {
    ...
    summary: 'Comprehensive study of Islamic law, its principles, methodology, and practical applications.',
    type: 'category',
    children: [
      {
        id: '3-1',
  ...
  },
  {
    ...
    summary: 'Fundamental beliefs and theological principles in Islam covering monotheism, prophethood, and eschatology.',
    type: 'category',
    children: [
      {
        id: '4-1',
...
The understanding of Tawheed has been refined through centuries of theological discourse, with scholars clarifying its implications against various philosophical challenges while maintaining scriptural authenticity.`
  ...
  },
  {
    ...
    summary: 'Comprehensive study of the life, character, and teachings of Prophet Muhammad (peace be upon him).',
    type: 'category',
    children: [
      {
        id: '5-1',
  ...
  },
  {
    ...
    summary: 'Comprehensive study of Islamic civilization from the prophetic era to modern times.',
    type: 'category',
    children: [
      {
        id: '6-1',
  ...
  },
  {
    ...
    summary: 'Philosophical traditions in Islamic thought including metaphysics, ethics, and logic.',
    type: 'category',
    badge: 'coming-soon'
  }
];