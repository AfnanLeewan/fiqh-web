...
!(function () {
        ...
        : (() => {
            const e = (() => {
              ...
              t = (t, n) => {
                let o = "";
                for (let r = t; r <= n; ++r)
                  o += e[r].toString(16).padStart(2, "0");
                return o;
              };
  ...
  const Ve = (e) => {
    ...
    gt = (e, t, n) => {
      ...
      if (((n = n || e), ut(e))) {
        ...
        for (const o in e)
          if (Se(e, o) && !1 === t.call(n, e[o], o, e)) return !1;
      return !0;
    },
    pt = (e, t) => {
      const n = [];
    ...
    kt = [
      ...
      },
      {
        ...
        search: (e) =>
          (Ge(e, "safari") || Ge(e, "mobile/")) && Ge(e, "applewebkit"),
      },
    ],
    Nt = [
      {
  ...
  const Gt = () => Yt(),
    ...
    ln = function (e, t, n, o) {
      ((o = o || this),
        e &&
          (n && (e = e[n]),
          gt(e, (e, r) => !1 !== t.call(o, e, r, n) && (ln(e, t, n, o), !0))));
    },
    dn = {
      trim: an,
      isArray: ft,
      is: (e, t) =>
        t ? !("array" !== t || !ft(e)) || typeof e === t : void 0 !== e,
      toArray: (e) => {
        if (ft(e)) return e;
        {
          const t = [];
  ...
  const rr = (e, t, n) => {
    ...
    _r = (e, t) =>
      ((e, t) => {
        ...
        return n.parentNode
          ? ((e, t) =>
              Z(e.dom.childNodes, (e) => t(mn.fromDom(e))).map(mn.fromDom))(
  ...
  const ks = (e, t, n, o) =>
    ...
    js = (e, t, n) => {
      ...
      q(To(n), (t) => {
        rr(t, s, a).each((n) => {
          const o = ((t) =>
            Y(Hn(t), (t) => s(t) && !e.isValidChild(En(n), En(t))))(t);
          if (o.length > 0) {
            const t = Mn(n);
            (q(o, (t) => {
              rr(t, s, a).each((n) => {
                ((e, t, n) => {
                  ...
                  if (r) {
                    ...
                    (zs(e, a, !1),
                      Rs(e, s, { checkRootAsContent: !0 }) ||
                        r.insertBefore(s, t),
                      Rs(e, n, { checkRootAsContent: !0 }) ||
                        r.insertBefore(n, t),
                      Rs(e, a, { checkRootAsContent: !0 }) ||
                        r.insertBefore(a, t),
                      r.removeChild(t));
                  }
                })(e, n.dom, t.dom);
                        ...
                        q(va(e, "|"), (e) => {
                          ...
                          if (a) {
                            ...
                            if (
                              ...
                              return (
                                delete r[i],
                                void s.splice(dn.inArray(s, i), 1)
                              );
                            if (
                              (l &&
                                ("=" === l
            ...
            for (
              ...
              if (t && d) {
                ...
                ("font-weight" === t && "700" === d
                  ...
                  "rgb" ==
                    ((E = d),
                    Ia.test(E) ? "rgb" : Fa.test(E) ? "rgba" : "other") &&
                    za(d).each((e) => {
      ...
      const a = ea.forElement(mn.fromDom(e), {
        ...
        k = (e, t, n) => {
          ...
          if (
            !y(o) &&
            (Qr(o) ||
              (Xr((r = o)) && "http://www.w3.org/2000/svg" === r.namespaceURI))
          )
            return n
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            u(e) ? Se(m, e) : Xr(e) && (Se(m, e.nodeName) || Ks(l, e)),
          root: null,
          ...
          createHTML: (e, t, n = "") => {
            ...
            for (const e in t)
              _e(t, e) && (o += " " + e + '="' + I(t[e]) + '"');
            return ot(n) && Se(l.getVoidElements(), e)
              ? o + " />"
              : o + ">" + n + "</" + e + ">";
          },
          createFragment: (t) => {
  ...
  const hi = N("mce-annotation"),
    ...
    Vi = (e) => (
      Hi(e) && (e = e.parentNode),
      $i(e) && e.hasAttribute("data-mce-caret")
    ),
    qi = (e) => Hi(e) && zi(e.data),
    Wi = (e) => Vi(e) || qi(e),
    ...
    Yi = (e) => {
      ...
      return (
        !!ss(t) &&
        (t.data.charAt(e.offset()) === Ui ||
          (e.isAtStart() && qi(t.previousSibling)))
      );
    },
    Gi = (e) => {
      const t = e.container();
      return (
        !!ss(t) &&
        (t.data.charAt(e.offset() - 1) === Ui ||
          (e.isAtEnd() && qi(t.nextSibling)))
      );
    },
    ...
    rl = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && ol(t.top - e.bottom, e, t))
      );
    },
    sl = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && ol(t.bottom - e.top, e, t)),
    al = (e, t, n) => {
    ...
    vl = Wi,
    yl = (e) =>
      !vl(e) && (gl(e) ? !pl(e.parentNode) : hl(e) || fl(e) || bl(e) || Cl(e)),
    Cl = (e) =>
      !((e) => Xr(e) && "true" === e.getAttribute("unselectable"))(e) && ul(e),
    wl = (e, t) =>
      yl(e) &&
      ((e, t) => {
        ...
        n ||
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                if (t < e.data.length) {
                  ...
                  if (
                    cl(e.data[t - 1]) &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), !Ll(o))
                  )
            ...
            if (El(r))
              if (e.isAtEnd()) {
                const e = Tl(r, s);
                (Rl(e) && o(e, e.data.length),
                  kl(e) && !Al(e) && n(Fl(Il(e), !1)));
              } else {
                const a = Tl(r, s);
                if ((Rl(a) && o(a, 0), kl(a) && e.isAtEnd()))
                  return (n(Fl(Il(a), !1)), t);
  ...
  ((Ul.fromRangeStart = (e) => Ul(e.startContainer, e.startOffset)),
    ...
    (Ul.isAbove = (e, t) =>
      je(le(t.getClientRects()), de(e.getClientRects()), rl).getOr(!1)),
    (Ul.isBelow = (e, t) =>
      je(de(t.getClientRects()), le(e.getClientRects()), sl).getOr(!1)),
  ...
  const zl = (e, t) => {
    ...
    Wl = (e) =>
      e
        ? bt(
            e.childNodes,
            (e, t) => (
              Hl(t) && "BR" !== t.nodeName ? (e = e.concat(Wl(t))) : e.push(t),
              e
            ),
            [],
          )
    ...
    od = (e, t, n) => {
      ...
      const s = ((e) =>
        nd(e.startContainer, e.startOffset) || nd(e.endContainer, e.endOffset))(
        r,
      );
      if (s) {
        const e = s.tagName;
    ...
    pd = (e) => {
      const t = Ve(V(e, md));
      return (
        q(t.errors, (e) => console.error(e.message, e.pattern)),
        t.values
      );
    },
    hd = (e, t, n) => {
    ...
    Eu = (e) =>
      ...
      ((e) =>
        !!Cl(e) &&
        !X(ce(e.getElementsByTagName("*")), (e, t) => e || ml(t), !1))(e),
    xu = wl,
    Su = (e, t) =>
      e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
    _u = (e, t) => {
      if (id(e)) {
        if (wu(t.previousSibling) && !vu(t.previousSibling))
          return Ul.before(t);
    ...
    ku = (e, t, n) => {
      ...
      if (t.isEqual(Ul.after(n)) && n.lastChild) {
        if (
          ((a = Ul.after(n.lastChild)),
          ld(e) && wu(n.lastChild) && yu(n.lastChild))
        )
    ...
    Ou = (e, t, n) =>
      Tu(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !Du(t, n) &&
                ((o = t), !(!Ul.isTextPosition(o) && ms(o.getNode()))) &&
                Au(t) &&
                Ru(n)
            : !Du(n, t) && Ru(t) && Au(n);
          var o;
    ...
    Bu = (e, t, n, o) =>
      Ou(e, t, n).bind((n) => (o(n) ? Bu(e, t, n, o) : I.some(n))),
    Pu = (e, t) => {
      ...
      return ss(n)
        ...
        : n
          ? yl(n)
            ? I.some(
                e ? Ul.before(n) : ms((o = n)) ? Ul.before(o) : Ul.after(o),
              )
            : ((e, t, n) => {
    ...
    Zu = (e, t) => {
      ((e, t) => {
        ...
        if (t) {
          ...
          if (((e) => Se(e, "rng"))(t))
            return I.some({ range: t.rng, forward: Vu(t) });
        }
        return I.none();
  ...
  const nf = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Ef = (e, t) =>
      !!e.getTextBlockElements()[t.nodeName.toLowerCase()] || Ks(e, t),
    ...
    Hf = (e, t) => {
      let n = t;
      for (; n; ) {
        if (Xr(n) && e.getContentEditable(n))
    ...
    Kf = (e, t, n, o, r, s) => {
        ...
        d = (t, n, o) => {
          ...
          return I.from(
            i(
              t,
              n,
              (e, t) => (Uf(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              l,
            ),
          );
        };
      return d(n, o, qf)
        .bind((e) =>
          s ? d(e.container, e.offset + (r ? -1 : 0), Wf) : I.some(e),
        )
        .orThunk(() =>
    ...
    Gf = (e, t, n, o) => {
      ...
      if (
        (s && Bf(i) && i.wrapper && (s = zf(e, s, "ul,ol").reverse()[0] || s),
        !s)
      )
        for (
          s = n;
          s && s[o] && !e.isBlock(s[o]) && ((s = s[o]), !Nf(s, "br"));
        );
      return s || n;
    },
    Xf = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || Xf(e, t, r, o))
      );
    },
    Qf = (e, t, n, o, r, s) => {
      let a = n;
    ...
    Jf = (e, t, n, o = {}) => {
      ...
      return (
        ...
        (Lf(u) || u.block_expand) &&
          ...
          (Lf(u) && ss(c) && m !== c.data.length) ||
            (c = Qf(e, n, c, m, !1, s))),
        Mf(u) &&
          ((l = Yf(e, n, t, l, "previousSibling")),
          (c = Yf(e, n, t, c, "nextSibling"))),
        (Bf(u) || Pf(u)) &&
          ...
          Bf(u) &&
            ...
            e.isBlock(c) ||
              ((c = Qf(e, n, c, m, !1, s)), ss(c) && (m = c.data.length)))),
  ...
  const ig = (e, t, n) =>
    ...
    dg = (e) =>
      Lr.range(
        e.start,
        lg(e.soffset, e.start),
        e.finish,
        lg(e.foffset, e.finish),
      ),
  ...
  const Eg = li.DOM,
    ...
    Sg = (e, t) => {
      const n = _c(e),
        o = Eg.getParent(
          t,
          (t) =>
            ((e) => Xr(e) && hg.isEditorUIElement(e))(t) ||
            (!!n && e.dom.is(t, n)),
        );
      return null !== o;
    },
    ...
    kg = (e, t) => {
      ...
      const o = (e, t) => {
        fm(e) &&
          !0 !== e.inline &&
          t(mn.fromDom(e.getContainer()), "tox-edit-focus");
      };
      (n.on("focusin", () => {
    ...
    Ng = (e, t) => {
      (e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor &&
          wg &&
          (Eg.unbind(document, "focusin", wg), (wg = null)));
    },
    Rg = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? I.from(ll(e.startContainer, e.startOffset)).map(mn.fromDom)
            : I.none())(t).bind((t) =>
          Pi(t) ? I.some(t) : yn(e, t) ? I.none() : I.some(e),
        ))(mn.fromDom(e.getBody()), t)
        .bind((e) => Iu(e.dom))
        .fold(
          () => {
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              so(n) ||
                ((o = n),
                ao(Gn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
    ...
    Bg = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || Bg.metaKeyPressed(e),
      metaKeyPressed: (e) =>
        ...
        L = (o) => {
          ...
          if (
            ...
            if (P(t, a) && P(e.getEnd(!0), a))
              return (n.setAttrib(a, Pg, i), void O.throttle(a));
          }
          B();
        },
        M = () => {
    ...
    qg = (e, t, n, o, r) => {
      ...
      const m = new Hr(r, c);
      for (; (d = m[o ? "prev" : "next"]()); ) {
        if ("false" === e.getContentEditableParent(d) || Hg(d, s))
          return I.none();
        if (ss(d) && d.data.length > 0)
          return $g(d, s, "A")
            ? I.none()
            : I.some(Ul(d, o ? d.data.length : 0));
    ...
    Wg = (e, t, n, o) => {
      ...
      if (
        (Xr(i) && l > i.childNodes.length - 1 && (m = !1),
        ds(i) && ((i = r), (l = 0)),
        i === r)
      ) {
  ...
  const Qg = (e) => "textarea" === En(e),
    ...
    ip = (e, t, n, o, r) => {
      ...
      a.top < i.y
        ? Qo(o.element, !1 !== r)
        : a.top > i.bottom && Qo(o.element, !0 === r);
    },
  ...
  const Sp = dn.makeMap(
    ...
    Ip = (e) => {
      ...
      q(t, (e) => {
        "all" === vo(e, "data-mce-bogus")
          ? _o(e)
          : Di(e)
            ? (io(e, mn.fromText(lt)), _o(e))
            : ko(e);
      });
    },
    Fp = (e) => {
            ...
            : "text" === t.format
              ? ((e, t) => {
                  ...
                  (ho(r, "data-mce-bogus", "all"),
                    ...
                    Ip(r),
                    Fp(r));
                  const s = ((e) => (Yn(e) ? e : mn.fromDom(Bn(e).dom.body)))(
                    o,
                  );
                  mo(s, r);
          ...
          serialize: (o) => {
            ...
            const a = (e) => {
              ...
              if (i) i(e);
                ...
                if ((n.start(s, l, i), Os(s)))
                  (u(e.value) && n.text(e.value, !0), n.end(s));
                else if (!i) {
                  let t = e.firstChild;
                  if (t) {
                    ("pre" !== s && "textarea" !== s) ||
  ...
  const qp = ["font", "text-decoration", "text-emphasis"],
    ...
    Qp = (e) => {
      ...
      return (
        ss(t) &&
        (0 === t.data.length || (zi(t.data) && ag.isBookmarkNode(t.parentNode)))
      );
    },
    Zp = (e, t) => (n) =>
      su(e ? 0 : -1, n)
    ...
    eh = (e) =>
      ps(e) && !((e) => Xr(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
    th = Zp(!0, Jp),
    nh = Zp(!1, Jp),
    oh = Zp(!0, Cs),
    rh = Zp(!1, Cs),
    ...
    dh = (e, t) =>
      ((e, t, n) =>
        yn(t, e) ? In(e, (e) => n(e) || vn(e, t)).slice(0, -1) : [])(e, t, L),
    ...
    Eh = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(mn.fromDom))(t).exists(Di) ||
      Ch(!1, e, t, n).isSome(),
    xh = D(Ch, !1),
    Sh = D(Ch, !0),
    ...
    Nh = (e, t, n) =>
      _h(t) ? Xp(t) : Xp(t) || Mu(kh(e, t, n).dom, t).exists(Xp),
    Rh = (e, t, n) =>
      _h(t) ? Gp(t) : Gp(t) || Lu(kh(e, t, n).dom, t).exists(Gp),
    Ah = (e) =>
      gu(e)
        .bind((e) => sr(e, Nn))
        .exists((e) =>
          ((e) => $(["pre", "pre-wrap"], e))(Uo(e, "white-space")),
        ),
    Dh = (e, t) => (n) => {
    ...
    Fh = (e, t, n, o) => {
      ...
      return n || !Lh(r, r.length - 1) || Ph(e, s, o)
        ? !!(n && Mh(r, r.length - 1) && Bh(e, s, o)) &&
            ((t.data = r.slice(0, -1) + dt), !0)
    ...
    qh = (e) => {
      return yl(e.previousSibling)
        ? I.some(
            ((t = e.previousSibling),
            ss(t) ? Ul(t, t.data.length) : Ul.after(t)),
          )
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              Wh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    Lu(e, Ul.after(t)).orThunk(() => Mu(e, Ul.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
      ...
      const l = ((e, t, n, o) => {
        ...
        return (
          ...
          a.isSome() && i.isSome() && l.isSome()
            ...
            () => (
              o &&
                (r.each((e) => $h(e.dom, e.dom.length, n)),
                s.each((e) => jh(e.dom, 0, n))),
              t
            ),
          )
        );
        ...
        s,
        e.schema,
        ((e, t) => Se(e.schema.getTextInlineElements(), En(t)))(e, n),
      );
    ...
    Qh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
    Zh = (e, t) =>
      hn(mn.fromDom(t), cc(e)) && !Ks(e.schema, t) && e.dom.isEditable(t),
    Jh = (e) => {
      var t;
      return (
    ...
    eb = (e, t, n) => {
      const o = ((e, t, n) => Y(li.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n,
      );
    ...
    yb = (e, t) =>
      lf(e.start, t).bind((n) => lf(e.end, t).bind((e) => $e(vn(n, e), n))),
    Cb = (e) => (t) =>
      yb(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, fb(e)),
      ),
    wb = (e, t, n, o) => {
    ...
    Eb = (e, t) => J(e, (e) => vn(e, t)),
    xb = (e) =>
      je(Eb(e.cells, e.rng.start), Eb(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1),
      ),
    Sb = (e, t) => {
              ...
              wb(e, t, n, o)
                ...
                .bind((e) => {
                  ...
                  if (o && e.cells.length === r.length)
                    return I.some(hb.fullTable(e.table));
                  if (r.length > 0) {
                    if (o) return I.some(hb.partialTable(r, I.none()));
                    {
                      const e = Sb(n, t);
                      return I.some(
                        hb.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              const s = ((e, t) =>
                I.from(e.dom.getParent(t, e.dom.isBlock)).map(mn.fromDom))(
                e,
              ...
              (n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? _o(n)
                      : (Fi(n), e.selection.setCursorLocation(n.dom, 0));
                  });
          ...
          ((e, t, n, o) => {
              ...
              As(e.schema, o, { checkRootAsContent: !1 })
                ...
                : ((e, t, n, o, r) =>
                    Ou(n, e.getBody(), r).bind((e) =>
                      Bb(t, mn.fromDom(e.getNode())).bind((e) =>
                        vn(e, o) ? I.none() : I.some(S),
                      ),
                    ))(e, n, t, o, r),
            );
          })(e, t, o, n).orThunk(() =>
            $e(
              ((e, t) => {
                ...
                return (
                  Mb(t, n) || Tu(t, e.getBody(), n).exists((e) => Mb(t, e))
                );
              })(e, t),
              S,
            ),
              ...
              : ((e, t, n, o) =>
                  Pb(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        _b(t, n).bind((t) =>
                          t.fold(D(Tb, e), D(Ob, e), D(Ab, e), D(Db, e)),
                        ))(e, t, n),
                    (t) => ((e, t) => Lb(e, t))(e, t),
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Kb = (e, t) => {
      if (Xr(e) && C(e.parentNode)) {
        ...
        ((t = ((e) => {
          ...
          for (; n; ) {
            if (n === e) return o;
            ((Xr(n) && "bookmark" === n.getAttribute("data-mce-type")) || o++,
              (n = n.nextSibling));
          }
          return -1;
        })(e)),
    ...
    rv = (e, t, n, o, r) => {
      ...
      if (s && Xr(t))
        for (let n = 0; n < s.length; n++) {
          ...
          if (
            nv(e.dom, t, i) &&
            ov(a, t, i, "attributes", r, o) &&
            ov(a, t, i, "styles", r, o)
          ) {
            const n = i.classes;
            if (n)
              for (let r = 0; r < n.length; r++)
                if (!e.dom.hasClass(t, kf(n[r], o))) return;
            return i;
          }
        }
    },
    ...
    cv = (e, t, n) => {
      const o = e.dom,
        r = e.selection;
      if (t) dv(e, t, n);
      else if (!(t = ju(e.getBody(), r.getStart())))
        for (; (t = o.get(Uu)); ) dv(e, t, n);
    },
    ...
    Ev = (e, t) =>
      !1 ===
      Lu(t, Ul.fromRangeEnd(e)).exists(
        (e) => !ms(e.getNode()) || Lu(t, e).isSome(),
      ),
    ...
    $v = (e, t, n) => {
      ...
      (Bf(n) &&
        ...
        (((e) => Pf(e) && Lf(e) && Ue(xe(e, "mixed"), !0))(n) &&
          !Mv(n.inline, t)) ||
          s.remove(t, !0));
    },
    Hv = (e, t, n) =>
      E(e) ? { name: t, value: null } : { name: e, value: kf(t, n) },
    Vv = (e, t) => {
      "" === e.getAttrib(t, "style") &&
    ...
    qv = (e, t, n, o, r) => {
      ...
      (Lv(n.styles, (a, i) => {
        const { name: l, value: d } = Hv(i, a, o),
          c = Rf(d, l);
        ((n.remove_similar || h(d) || !Xr(r) || Mv(Af(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0));
      }),
        s && Vv(e, t));
    ...
    Wv = (e, t, n, o, r) => {
      ...
      if (!t.ceFalseOverride && o && "false" === s.getContentEditableParent(o))
        return Bv.keep();
      if (o && !nv(s, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return Bv.keep();
      const l = o,
      ...
      if ("all" !== t.remove) {
        (qv(s, l, t, n, r),
          ...
          Lv(t.classes, (e) => {
            ((e = kf(e, n)),
              (Xr(r) && !s.hasClass(r, e)) || s.removeClass(l, e));
          }));
          ...
          const s = e.formatter.get(t),
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                    ...
                    for (
                      let n = 0;
                      n < t.length && ((o = Kv(e, t[n], i, o)), null !== o);
                      n++
                    );
            ...
            u = (e) => {
              ...
              if (t) {
                ...
                return (
                  ((e) =>
                    Ju(e) && Xr(e) && ("_start" === e.id || "_end" === e.id))(
                    n,
            ...
            f = (t) => {
              ...
              if (a.split) {
                if (
                  ((r = Gg(r)), (n = Fv(e, r, !0)), (o = Fv(e, r)), n !== o)
                ) {
    ...
    Gv = (e, t, n, o, r) =>
      Wv(e, t, n, o, r).fold(L, (t) => (e.dom.rename(o, t), !0), M),
    Xv = ["fontsize", "subscript", "superscript"],
    Qv = ["strikethrough", ...Xv],
    Zv = (e, t) =>
      H(Xv, (n) =>
        ((e, t, n) => C(e.matchNode(t.dom, n, {}, "fontsize" === n)))(e, t, n),
      ),
    Jv = (e, t, n, o, r) => {
      ...
      q(t, (t) => {
        ((e, t, n, o, r) => {
          ...
          ({ container: o, innerWrapper: s, outerWrappers: a }) => {
            (e.split(o.dom, t.dom),
              ((e, t, n, o) => {
                (q(Hn(e), (e) => {
  ...
  var NC = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : kC();
    const n = (t) => e(t);
    if (
      ((n.version = "3.2.6"),
      (n.removed = []),
      ...
      De = function () {
        ...
        if (!Ne || Ne !== e) {
          if (
            ...
            (e = nC(e)),
            (Se =
              -1 === _e.indexOf(e.PARSER_MEDIA_TYPE)
                ? "text/html"
                : e.PARSER_MEDIA_TYPE),
            (ke = "application/xhtml+xml" === Se ? Vy : Hy),
            (F = Gy(e, "ALLOWED_TAGS") ? eC({}, e.ALLOWED_TAGS, ke) : U),
            (z = Gy(e, "ALLOWED_ATTR") ? eC({}, e.ALLOWED_ATTR, ke) : j),
            (ye = Gy(e, "ALLOWED_NAMESPACES")
              ? eC({}, e.ALLOWED_NAMESPACES, Vy)
              : Ce),
            (ue = Gy(e, "ADD_URI_SAFE_ATTR")
              ? eC(nC(fe), e.ADD_URI_SAFE_ATTR, ke)
              : fe),
            (ce = Gy(e, "ADD_DATA_URI_TAGS")
              ? eC(nC(me), e.ADD_DATA_URI_TAGS, ke)
              : me),
            (le = Gy(e, "FORBID_CONTENTS")
              ? eC({}, e.FORBID_CONTENTS, ke)
              : de),
            ...
            e.FORBID_CONTENTS &&
              (le === de && (le = nC(le)), eC(le, e.FORBID_CONTENTS, ke)),
            se && (F["#text"] = !0),
    ...
    const ze = function (e) {
        ...
        if (!F[o] || H[o]) {
          if (!H[o] && $e(o)) {
            if ($.tagNameCheck instanceof RegExp && Xy($.tagNameCheck, o))
              return !1;
        ...
        return e instanceof d &&
          ...
          : ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
            ...
            ? (G &&
                ...
                e.textContent !== t &&
                  (jy(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
          ...
          if (
            !(
              ($e(e) &&
                ...
                (($.attributeNameCheck instanceof RegExp &&
                  Xy($.attributeNameCheck, t)) ||
                  ($.attributeNameCheck instanceof Function &&
                    $.attributeNameCheck(t)))) ||
              ("is" === t &&
                $.allowCustomizedBuiltInElements &&
      ...
      (n.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Qy("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Qy("dirty is not a string, aborting");
        }
        if (!n.isSupported) return e;
        if (
          (Z || De(t), (n.removed = []), "string" == typeof e && (ae = !1), ae)
        ) {
          if (e.nodeName) {
        ...
        const c = Me(ae ? e : o);
        for (; (i = c.nextNode()); )
          (ze(i), He(i), i.content instanceof a && Ve(i.content));
        if (ae) return e;
        if (ee) {
          if (te)
          ...
          return (
            (z.shadowroot || z.shadowrootmode) && (d = N.call(r, d, !0)),
            d
          );
        }
  ...
  const FC = (e, t, n, o, r) => {
    ...
    zC = (e, t) =>
      e.hasAttribute(MC) && ("id" === t || "class" === t || "style" === t),
        ...
        p = {
          ...
          parse: (e, n = {}) => {
            ...
            const d = r.validate,
              c =
                "#document" ===
                (null !== (o = n.context) && void 0 !== o ? o : r.root_name),
              u =
                null !== (i = n.context) && void 0 !== i
                  ? i
                  : c
                    ? "html"
                    : r.root_name,
            ...
            const [h, b] = ((e, t, n, o) => {
                const r = n.validate,
                  ...
                  f = (n) =>
                    n.name in i || Gs(t, n) || (Os(n.name) && n.parent === e),
                  g = (t, n) => {
            ...
            (((e, t, n) => {
              ...
              d &&
                v.length > 0 &&
                (n.context ? (n.invalid = !0) : cy(v, t, p, x)));
            const _ = ((e, t) => {
              var n;
              const o =
    ...
    JC = (e, t, n) => {
      ...
      if (ZC(e)) {
        if (r.content !== o) {
          const t = QC({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name },
          );
          return { ...r, content: t };
        ...
        (e) => (
          ...
          t.filter(Rn).map((t) =>
            ((e, t, n, o, r) => {
              ...
              o
                ? (Hh(s, a, r, !1, !o), n.setStart(a, i))
                : (Hh(a, s, r, !1, !o), n.setEnd(a, i));
            })(e, t, n, o, r),
          )
        ),
      ).orThunk(() => {
        const e = ((e, t) =>
          e.filter((e) => ag.isBookmarkNode(e.dom)).bind(t ? zn : Un))(t, o)
          .or(t)
          .filter(Rn);
        return e.map((e) =>
          ((e, t, n) => {
    ...
    _w = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
            ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Sw(t[0], n)))(
                s,
                a,
                d,
                t,
    ...
    Rw = (e, t) => {
      ...
      if (t) {
        ...
        (dn.each(a, (e) => {
          ...
          if (
            !Kp(o, (l = e)) &&
            !((e, t) => Kp(e, t) && H(Wp(e, t), (e) => ((e) => Vp.has(e))(e)))(
              o,
              l,
            ) &&
            a(e) &&
            ...
            const n = Wp(o, e),
              ...
              d = (t) =>
                ...
                o.is(t, s) &&
                a(t) &&
                ((t.nodeName === e.nodeName && l(n, Wp(o, t))) ||
                  d(t.children[0])),
              c = (n) =>
              ...
              m = (n) =>
                ...
                (((e, t, n) => {
                  ...
                  m(n.parentElement));
            (d(e.children[0]) || (c(e.parentElement) && !m(e.parentElement))) &&
              o.remove(e, !0);
          }
          var l;
        }),
    ...
    Aw = (e, t, n) => {
      ...
      (m === u &&
        ...
        ((c = s.createRng()),
        c.setStart(u.firstChild, 0),
        c.setEnd(u.firstChild, 0),
        r.setRng(c)),
        r.isCollapsed() ||
          ((e) => {
            const t = e.dom,
            ...
            ((e, t, n) =>
              !!C(n) &&
              n === e.getParent(t.endContainer, Nw) &&
              mf(mn.fromDom(n), t))(t, n, o)
              ? Tb(e, n, mn.fromDom(o))
              : hf(n, fs) || ((r = n), hf(r, ss))
                ? n.deleteContents()
  ...
  const Bw = dn.each,
        ...
        m = (a, i, l) => {
          ...
          (eg(a, i, (o) => {
            ...
            const c = (o) => {
              ...
              if (
                ((o) =>
                  ((e) => Bf(e) && !0 === e.wrapper)(s) && rv(e, o, t, n))(o)
              )
                i = null;
              else {
                if (
                ...
                ((t, n, o, r) => {
                  ...
                  ? (i ||
                      ((i = a.clone(g, !1)), v.insertBefore(i, o), m.push(i)),
                    b && p && (u = h),
                    i.appendChild(o))
                  : ((i = null),
                    q(ce(o.childNodes), c),
                  ...
                  (s.exact ||
                    ...
                    (o = ((t) => {
                      const o = Z(t.childNodes, vf).filter(
                        (e) =>
                          "false" !== a.getContentEditable(e) && nv(a, e, s),
                      );
                      return o
                        .map((o) => {
                          const r = a.clone(o, !1);
    ...
    Yw = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (vn(o[n], t)) return I.some(Vw(n, e));
      }
      return I.none();
    },
    Gw = (e, t, n, o, r) => {
        ...
        : ((e, t, n) =>
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t, n) =>
                  ...
                  })(mn.fromDom(t.cloneContents()), Qw(e, t, n)))(e, t[0], n))(
            e,
            t,
            n,
          );
    ...
    gE = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !cE(aE(e), t.data[0])))(
            e,
            t,
            n,
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (fE(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n,
          ),
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                Rr(
                  ...
                  (n) =>
                    me(t, (t) =>
                      ((t, n) => (rv(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
        ...
        getContent: (t) =>
          ((e, t) =>
            I.from(e.getBody()).fold(
              N("tree" === t.format ? new xp("body", 11) : ""),
              (n) => Up(e, t, n),
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
                ...
                ZC(t)
                  ...
                  : ((e, t, n, o) => {
                      ...
                      }
                      {
                        ...
                        return (
                          Dw(e, r, o.no_selection),
                          { content: r, html: r }
                        );
                      }
                    })(e, o, t, n),
              )
              .getOr({ content: t, html: ZC(n.content) ? "" : n.content }))(
            e,
            t,
            n,
          ),
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), tE(d, 0) || tE(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = nE(e),
                            n = t.indexOf(l);
  ...
  const CE = (e) =>
      !(!e || !e.ownerDocument) &&
      yn(mn.fromDom(e.ownerDocument), mn.fromDom(e)),
    wE = (e, t, n, o) => {
      let r, s;
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        d = () => {
          ...
          if (C(o.bookmark) && !Dg(o)) {
            const e = pg(o);
            if (e.isSome())
              return e.map((e) => vp(o, [e])[0]).getOr(i.createRange());
          }
          try {
            const e = l();
            e &&
          ...
          if (
            (n || (n = i.createRange()), ds(n.startContainer) && n.collapsed)
          ) {
            const t = e.getRoot();
        ...
        c = (e, t) => {
          if (!((e) => !!e && CE(e.startContainer) && CE(e.endContainer))(e))
            return;
          const n = l();
          if (
        ...
        u = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => bE(e).selection.getContent(t, n))(
                e,
    ...
    UE = (e) => {
      ...
      const n = () => {
        ...
        r = (n) => {
          ...
          const o = me(t, ({ instanceApi: e, triggerElement: t }) =>
            e === n ? t : I.none(),
          );
    ...
    JE = (e) => {
      const t = ((e) => (u(Sm(e)) ? "online" : "offline"))(e),
        n = ((e) => {
          var t;
          const n =
            null === (t = xm(e)) || void 0 === t ? void 0 : t.toLowerCase();
    ...
    cx = (e) => {
      (e.parser.addAttributeFilter("contenteditable", (t) => {
        ix(e) &&
          q(t, (e) => {
            (e.attr(lx, e.attr("contenteditable")),
        ...
        findAll: (o, r = M) => {
          const s = Y(
            ...
            a = V(s, (e) => {
              ...
              if (Se(n, o))
                return n[o].then((t) =>
                  u(t) ? t : { image: e, blobInfo: t.blobInfo },
                );
              {
                const r = ((e, t) => {
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        Xe(o, "blob:")
                          ...
                          yy(t).then((o) =>
                            wy(o, !1, (n) => I.some(Ey(e, t, n))).getOrThunk(n),
                          ),
                        );
                  }
                  var o, r;
  ...
  const bx = (e, t) => {
                  ...
                  const a = V(n, (n, a) => {
                    ...
                    return (
                      n.status && Wd(e)
                        ...
                        : n.error &&
                          (n.error.remove &&
                            (d(l.src, rn.transparentSrc), r.push(l), (c = !0)),
                          ((e, t) => {
                            jE(
                              e,
                              gi.translate(["Failed to upload image: {0}", t]),
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
                            ...
                            (_o(n),
                              o.each(
                                ((e) => (t) => {
                                  ((e, t) =>
                                    e.dom.isEmpty(t.dom) &&
                                    C(e.schema.getTextBlockElements()[En(t)]))(
                                    e,
                                    t,
                                  ) &&
                                    mo(
                                      t,
                                      mn.fromHtml('<br data-mce-bogus="1" />'),
                                    );
                                })(e),
                              ),
    ...
    Tx = (e) => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => bE(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => bE(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => bE(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              bE(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: D(Dx, e),
        }
      );
    },
    ...
    Bx = (e) => {
      const t = We(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => bE(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => bE(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => bE(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => bE(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => bE(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
          ...
          ((e, t, n) => {
            ...
            (e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                (rn.os.isMacOS() ? e.metaKey : e.ctrlKey && !e.altKey) &&
                  t.beforeChange();
              }),
              e.on("mousedown", (e) => {
                t.typing && r(e);
    ...
    rS = (e) => {
      ...
      return Y(
        ((e, t) => {
          const n = dn.map(
            t,
            (t) => e.dom.getParent(t, "li,dd,dt", aS(e, t)) || t,
          );
          return ue(n);
        })(e, t),
        Hx,
      ...
      const n = e.dom.getParents(t, e.dom.isBlock),
        o = Z(n, (t) => {
          return (
            ...
            !jx((o = t)) &&
              !Hx(o) &&
              H(tS, (e) => n.isValidChild(o.nodeName, e)))
          );
          var n, o;
        });
      ...
      for (
        ...
        (c ||
          ...
          Kx(l, r)
            ...
            : (d || ((d = o.create(a, i)), s.appendChild(d)),
              d.appendChild(l)));
      }
      return (
        !c && d && d.appendChild(o.create("br", { "data-mce-bogus": "1" })),
        s
      );
    },
    gS = (e) => Cn(e, "OL,UL"),
      ...
      q(e, (t, n) => {
        ((e, t) => {
          const n = e[t].depth,
            ...
            r = (e) => e.depth < n;
          return Q(oe(e.slice(0, t)), o, r).orThunk(() =>
            Q(e.slice(t + 1), o, r),
          );
        })(e, n).fold(
          () => {
    ...
    AS = (e, t, n) => {
      const o = ((e, t) => {
        ...
        ((e) => {
          ...
          return je(Z(t, T(pS)), Z(oe(t), T(pS)), (e, t) => ({
            start: e,
            end: t,
          }));
        })(e),
                  ...
                  : OS(t) &&
                    Mn(t).each((n) =>
                      ((e, t, n) => {
                        ...
                        (e.dom.isEmpty(a) || DS.insertAfter(a, t),
                          DS.insertAfter(r, t));
            ...
            return Z(n, (e) => {
              return (
                ...
                Ln(t).exists(
                  (e) =>
                    Hx(e.dom) &&
                    qn(e).exists((e) => !jx(e.dom)) &&
                    Wn(e).exists((e) => !jx(e.dom)),
                )
              );
              var t;
            }).fold(
      ...
      const a = (t, n) => {
        ...
        for (; (i = s[a]()); )
          if (
            ...
            !ct(i.textContent) &&
            0 !==
              (null === (r = i.textContent) || void 0 === r ? void 0 : r.length)
          )
            return I.some(i);
        return I.none();
      };
      if (n && Ux(r))
        if (ct(r.textContent)) r = a(r, !1).getOr(r);
          ...
          for (
            ...
            (HS(e, r.previousSibling) || Ux(r.previousSibling));
          )
            r = r.previousSibling;
      if (!n && Ux(r))
        if (ct(r.textContent)) r = a(r, !0).getOr(r);
          ...
          for (
            null !== r.parentNode && HS(e, r.parentNode) && (r = r.parentNode);
            null !== r.nextSibling &&
            (HS(e, r.nextSibling) || Ux(r.nextSibling));
          )
            r = r.nextSibling;
      for (; r.parentNode !== o; ) {
          ...
          ((e, t, n) => {
            ...
            return (
              dn.each(l, (t) => {
                ...
                if (r.isBlock(t) || qx(t))
                  return (qx(t) && r.remove(t), void (i = null));
                const a = t.nextSibling;
                ag.isBookmarkNode(t) &&
                (jx(a) || Wx(e, a) || (!a && t.parentNode === n))
                  ? (i = null)
                  : (i ||
                      ((i = r.create("p")),
                      null === (s = t.parentNode) ||
    ...
    WS = (e, t, n) => {
      return (
        ((e, t) => jx(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(
          t,
          n,
        ) &&
        ((e, t, n) =>
    ...
    ZS = (e, t, n, o) => {
      ...
      n &&
        ((e, t) =>
          !!qx(t) && e.isBlock(t.nextSibling) && !qx(t.previousSibling))(
          e.dom,
          r,
        ) &&
        i.next();
          ...
          return (
            e.undoManager.transact(() => {
              ...
              t
                ...
                : (null === (o = (n = a).parentNode) || void 0 === o
                      ? void 0
                      : o.firstChild) === n
                  ? FS(e)
                  : ((e, t, n, o) => {
            ...
            ? ((e, t, n, o) => {
                ...
                return je(r, s, s_).filter(
                  (e) =>
                    ...
                    ((e) =>
                      !1 === ps(e.from.block.dom) && !1 === ps(e.to.block.dom))(
                      e,
                    ) &&
                    ((e) => {
                    ...
                    ((e) =>
                      !(
                        yn(e.to.block, e.from.block) ||
                        yn(e.from.block, e.to.block)
                      ))(e),
                );
              })(e, t, n, o)
    ...
    b_ = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => h_(e, t.startContainer) || h_(e, t.endContainer))(e, t) &&
          n &&
          o
        );
    ...
    A_ = (e, t, n, o) =>
      Tu(t, e, n).bind((r) => {
        return (
          ...
          ((e, t, n, o, r) => {
            const s = (t) =>
              r.isInline(t.nodeName.toLowerCase()) && !ru(n, o, e);
            ...
            : (t && ps(r.getNode())) || (!t && ps(r.getNode(!0)))
              ? ((e, t, n, o, r) => {
                  ...
                  return lb(mn.fromDom(t), mn.fromDom(o.getNode()))
                    .map((t) =>
                      As(e, t) ? R_.remove(t.dom) : R_.moveToElement(s),
                    )
                      ...
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? "after" : "before";
                            return (
                              Xr(n) && n.getAttribute("data-mce-caret") === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && ps(t.nextSibling)
                                    ...
                                    : !e && ps(t.previousSibling)
                                      ? I.some(
                                          R_.moveToElement(t.previousSibling),
                                        )
      ...
      e
        ? ((e) => {
            ...
            if (M_(e.previousSibling))
              return (
                F_(e.previousSibling) || e.previousSibling.appendData(Ui),
                e.previousSibling
              );
        ...
        : ((e) => {
            ...
            if (M_(e.nextSibling))
              return (
                I_(e.nextSibling) || e.nextSibling.insertData(0, Ui),
                e.nextSibling
              );
    ...
    $_ = D(z_, !1),
    H_ = (e, t) =>
      ss(e.container()) ? z_(t, e.container()) : z_(t, e.getNode()),
    V_ = (e, t) => {
      const n = t.get();
    ...
    Z_ = (e, t, n) => {
      const o = ob(n);
      return Q_(e, t, o).bind((e) =>
        Mu(e, o).isNone() ? I.some(K_.start(e)) : I.none(),
      );
    },
    J_ = (e, t, n) => {
      const o = nb(n);
      return Q_(e, t, o).bind((e) =>
        Lu(e, o).isNone() ? I.some(K_.end(e)) : I.none(),
      );
    },
    ek = (e, t, n) => {
      const o = ob(n),
  ...
  const uk = (e, t) => (-1 === e ? oe(t) : t),
    ...
    gk = (e, t, n, o) =>
      ms(o.getNode(1 === t)) ? mk.Br : !1 === ru(n, o) ? mk.Block : mk.Wrap,
    pk = (e, t, n, o) => {
      const r = Nu(n);
      let s = o;
      const a = [];
  ...
  const Pk = (e, t, n, o, r, s) => {
      ...
      const i = [],
        l = (o) => {
          ...
          for (let e = 0; e < s.length; e++) {
            const o = s[e];
            if (!n(o, d)) {
              if ((i.length > 0 && t(o, yt(i)) && a++, (o.line = a), r(o)))
                return !0;
              i.push(o);
            }
          }
    ...
    oN = (e, t, n, o) => {
      ...
      (e.undoManager.ignore(() => {
        (e.selection.setRng(
          ...
          sb(e),
          nk(s, r, Ul.fromRangeStart(e.selection.getRng()))
            .map(ak)
            .bind(nN(e, t))
            .each(P));
      }),
    ...
    dN = (e, t) => {
      const n = Y(
        ((e) => sN(e, (t) => e.schema.isBlock(En(t)) || ((e) => Kn(e) > 1)(t)))(
          e,
        ),
        aN,
      );
    ...
    _N = (e) => {
      if (e.selection.isCollapsed() && CN(e)) {
        ...
        if (null !== r && ph(mn.fromDom(r), o, e.schema))
          return I.some(() => SN(e));
      }
      return I.none();
    },
      ...
      e.selection.isCollapsed()
        ...
        : ((e, t) => {
            return (
              (n = uy(e.selection.getRng())),
              hf(n, Qr)
                ? I.some(() => Xh(e, t, mn.fromDom(e.selection.getNode())))
                : I.none()
            );
            var n;
          })(e, t),
    NN = (e, t, n) =>
      me(
        [_N, B_, __, (e, n) => rN(e, t, n), p_, Fb, L_, bN, v_, gN, P_, kN],
        (t) => t(e, n),
    ...
    TN = (e, t) =>
      !!ss(t) ||
      (!!Xr(t) &&
        !(DN(e.getBlockElements(), t) || Ju(t) || Ks(e, t) || Bs(t) || ys(t))),
    ON = (e, t) => {
      if (ss(t)) {
    ...
    KN = (e, t) =>
      ((e, t) => {
        const n = Ul.fromRangeStart(e.selection.getRng()),
          ...
          r = mn.fromDom(e.getBody());
        return je(WN(n, r), WN(o, r), (e, t) =>
          vn(e, t) ? I.some(e) : I.none(),
        )
          .bind(R)
          .fold(
            L,
            (r) =>
              ...
              ((e, t, n) =>
                (n ? kk : _k)(e.getBody(), t).map((e) => e.toRange()))(
                e,
                t ? o : n,
                t,
              ).exists((t) => (zk(e, t), !0)),
    ...
    sR = (e, t, n) =>
      te(Hn(e), (e) => (hn(e, t) ? (n(e) ? [e] : []) : sR(e, t, n))),
    aR = (e, t) => dr(e, "table", t),
    iR = ke([
      { none: ["current"] },
      { first: ["current"] },
  ...
  const SR = Pe("mode"),
    ...
    zR = (e, t, n) => {
      ...
      return ((e) => e.breakType === mk.Wrap && 0 === e.positions.length)(o) ||
        (!ms(n.getNode()) &&
          ((e) => e.breakType === mk.Br && 1 === e.positions.length)(o))
    ...
    GR = (e, t, n) =>
      n.fold(
        ...
        (n) =>
          !e.mode.isReadOnly() &&
          XR(n) &&
          ((e) => JR(e) || Fn(e).some((e) => kn(e) && JR(e)))(n)
      ...
      return ((e, t) =>
        ((e, t, n = L) =>
          n(t)
            ...
            : $(e, En(t))
              ? I.some(t)
              : ir(t, e.join(","), (e) => hn(e, "table") || n(e)))(
          ["td", "th"],
          e,
          t,
        ))(mn.fromDom(t ? s.endContainer : s.startContainer), r)
        .map(
          (n) => (
            aR(n, r).each((t) => {
    ...
    iA = (e, t, n) => {
      ...
      {
        const r = Ri(oA);
        return I.from(r.forwards(e, t, rA(e), n)).bind((e) =>
          iA(e.container, t - o.length, n),
        );
      }
    },
    lA = (e, t, n, o, r) => {
    ...
    mA = (e, t, n, o = !1) => {
      ...
      return lA(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: cA(r, n), range: o, trigger: n });
      });
    },
    uA = (e) => {
  ...
  EA((e) =>
    AA(e)
      ? bA(e)
      : vA("Expected value to be acceptable for sending via postMessage"),
  );
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === pA.Value
                  ? { stype: pA.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            },
    ...
    MA = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === pA.Error
              ? { stype: pA.Error, serror: t(e.serror) }
  ...
  const ZA = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                mA(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  gA(e, s, t, n),
                ),
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => me(n.triggers, (n) => mA(e, t, n)))(
                    e.dom,
                    o,
                    n,
                  ).bind((n) => gA(e, t, n));
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Ou(!t, s, n).exists((e) => oD(o, e) && !ze(i, nD(o, e)))
          ) ||
          Ou(t, s, n).fold(L, (n) => {
            const r = nD(o, n);
            if (oD(o, n) && !ze(i, r)) {
              ...
              t.startSummary.exists((t) =>
                ((e, t) =>
                  Fu(t).exists(
                    (n) =>
                      (ms(n.getNode()) &&
                        Mu(t, n).exists((t) => t.isEqual(e))) ||
                      n.isEqual(e),
                  ))(e, t),
              ))(s, t) ||
            ((e, t, n) =>
              n.startDetails.exists((n) =>
                Lu(e, t).forall((e) => !n.contains(e.container())),
              ))(a, s, t)
          : ((e, t) =>
              t.startSummary.exists((t) =>
                ((e, t) => Iu(t).exists((t) => t.isEqual(e)))(e, t),
              ))(s, t) ||
            ((e, t) =>
    ...
    OD = {
      insert: (e, t) => {
          ...
          w = () => {
            ...
            return (
              ...
              ((e, t) => {
                ...
                return (
                  !y(t) &&
                  (u(n) ? $(dn.explode(n), t.nodeName.toLowerCase()) : n)
                );
              })(e, s) &&
              DD(i, s) &&
        ...
        if (p)
          ...
          ((R = Zi(_)), i.isEmpty(_) && yD(_), CD(e, R), hD(e, R));
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          const t = Ul.fromRangeStart(d),
            ...
            o = mn.fromDom(_),
            r = Eh(o, t, e.schema)
              ? xh(o, t, e.schema).bind((e) => I.from(e.getNode()))
              : I.none();
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                TD(!0, e.startContainer, e.startOffset),
              ),
    ...
    qD = (e, t) => (n, o) => {
      const r =
        ((e) => vD(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    WD = (e) => {
    ...
    lT = (e, t, n) => {
      (n && !e.get()
        ? t.on("NodeChange", aT, !0)
        : !n && e.get() && t.off("NodeChange", aT),
        e.set(n));
    },
    ...
    hT = (e) =>
      bm(e)
        ...
        : [],
    bT = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), ZA(e), pE(e)))
        return Ne(null);
      {
        const t = Zk(e);
        return (
                    ...
                    tR(
                      [
                        ...
                        ...(gD
                          ? [
                              {
                                keyCode: Bg.BACKSPACE,
                                altKey: !0,
                                action: JN(lD, e, !1, a(!0)),
                              },
                              {
                                keyCode: Bg.DELETE,
                                altKey: !0,
                                action: JN(lD, e, !0, a(!0)),
                              },
                              {
                                keyCode: Bg.BACKSPACE,
                                metaKey: !0,
                                action: JN(lD, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                      ...
                      .each((t) => {
                        (n.preventDefault(),
                          mD(e, o).isDefaultPrevented() || (t(), cD(e, o)));
                      });
                  })(e, t, r));
            }),
              e.on("keyup", (t) => {
    ...
    wT = (e) => {
      const t = (t, n) => {
        ...
        n = X(
          e.children(),
          (e, n) => (yT(n) ? [...e, n] : CT(e) || yT(n) ? e : (t(e, n), [])),
          [],
        );
      CT(n) || t(n);
    },
                  ...
                  null === n ||
                    ...
                    e.undoManager.transact(() => {
                      (f(t.styles) && e.dom.setStyles(n, t.styles),
                        f(t.attrs) &&
                          pe(t.attrs, (t, o) => e.dom.setAttrib(n, o, t)));
                    });
                })(e, n);
            }),
  ...
  const ST = "x-tinymce/html",
    ...
    UT = (e, t, n) =>
      !!((e, t) =>
        IT(t) && H(hm(e), (e) => Qe(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t,
      ) &&
      ((e, t, n) => (
    ...
    $T = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? mD(e, "insertFromPaste", {
              dataTransfer: jT(t),
            }).isDefaultPrevented() || (n(), cD(e, "insertFromPaste"))
          : n();
      }
    },
    HT = (e, t, n, o) => {
      ...
      if (Xc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => yy(e).then((t) => ({ file: e, uri: t }))),
            )).then((t) => {
    ...
    XT = (e, t, n) => {
      (((e, t, n) => {
        ...
        (e.on("keydown", (e) => {
          ((e) =>
            (Bg.metaKeyPressed(e) && 86 === e.keyCode) ||
        ...
        ((e, t) => {
          (e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              (n.html && HT(e, n.html, n.internal, !1),
                n.text && VT(e, n.text, !1));
            }));
        })(e, o),
        ((e) => {
          const t = (t) => (n) => {
      ...
      const t = ((e, t, n) => {
        const o = Ul.fromRangeStart(e).getNode(),
          r = ((e, t, n) =>
            sr(
              mn.fromDom(e),
              (e) => ((e) => gs(e.dom))(e) || n.isBlock(En(e)),
              cO(t),
            ).getOr(mn.fromDom(t)).dom)(o, t, n),
          s = uO(o, r, !1),
          a = uO(o, r, !0),
  ...
  const pO = (e, t) => Math.abs(e.left - t),
        ...
        s = (e, s) => {
          ...
          return me(a, r).map((e) =>
            o && !ss(e.node) && a.length > 1
              ? ((e, o, s) =>
                  r(o).filter(
                    (o) => Math.abs(s(e, t, n) - s(o, t, n)) < 2 && ss(o.node),
                  ))(e, a[1], s).getOr(e)
              : e,
          );
        },
    ...
    CO = (e, t, n) =>
      ((e, t, n) => {
        ...
        return ((e, t, n, o) => {
          const r = (t, s) => {
            ...
            return s
              ...
              .orThunk(() =>
                (vn(t, e) ? I.none() : Mn(t)).bind((e) => r(e, I.some(t))),
              );
          };
          return r(t, I.none());
        })(o, s, t, n);
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: pO(e, t) < hO(e, t) ? gO.Before : gO.After,
          }))(e, t),
        ),
    wO = (e) => {
      var t, n;
    ...
    xO = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...EO(n) }))(
            e,
            o,
            t,
            r,
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? wO(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
      ...
      const l = (e) =>
        ...
        g = () => {
          (i && i.removeAttribute(a),
            lr(mn.fromDom(e.getBody()), "#" + s).each(_o),
            (i = null));
        },
        p = () => {
          r.hide();
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = UO(e, n);
              FO(o)
                ? (t.preventDefault(), C_(e, o).each(f))
                : l(n) && C_(e, n).each(f);
            },
            !0,
          ),
          e.on("mousedown", (r) => {
            ...
            FO(a)
              ...
              : CO(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  (r.preventDefault(),
                    (o = d(1, n.node, n.position === gO.Before, !1)) &&
                      t.setRng(o),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            jE(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      Sg(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (Cs(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    C_(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    jO = (e, t) => {
      let n = t;
      for (let t = e.previousSibling; ss(t); t = t.previousSibling)
        n += t.data.length;
      return n;
    },
    $O = (e, t, n, o, r) => {
    ...
    eB = (e, t, n) => {
      (WO(e, e.get(t.prefix + "-end"), n),
        WO(e, e.get(t.prefix + "-start"), n));
    },
    ...
    lB = (e, t, n) =>
      ((e, t, n) => {
        ...
        {
          const t = Ri(oA);
          return I.from(t.forwards(e, 0, rA(e), n)).map((e) =>
            nA(e.container, 0),
          );
        }
      })(t, 0, t).map((o) => {
    ...
    yB = (e) => {
      ...
      (e.on("keyup", (e) => {
        ...
        e.on("keypress", (n) => {
          vB(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            bg.setEditorTimeout(e, s);
        }));
    },
    CB = (e) => {
      const t = dn.each,
                  ...
                  if (n.keyCode === Bg.LEFT || n.keyCode === Bg.RIGHT) {
                    ...
                    t(o) &&
                      ...
                      Ln(o)
                        .bind((t) => {
                          var r;
                          return 0 === e.selection.getRng().startOffset &&
                            n.keyCode === Bg.LEFT
                            ? Un(t)
                            : e.selection.getRng().endOffset ===
                                  (null === (r = o.dom.textContent) ||
                                  void 0 === r
                                    ? void 0
              ...
              e.on("mousedown", (t) => {
                je(I.from(t.clientX), I.from(t.clientY), (n, o) => {
                  ...
                  const s = e.getDoc().caretPositionFromPoint(n, o),
                    a =
                      (null === (r = null == s ? void 0 : s.offsetNode) ||
                      void 0 === r
                        ? void 0
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(ux(e)),
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(ux(t));
                return u(n)
                  ? Promise.resolve(kB(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, kB(e).loadAll(r)];
    ...
    AB = (e) => {
          ...
          e.on("NodeChange", () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) =>
                  H(dh(mn.fromDom(n), mn.fromDom(t)), (t) => DN(e, t.dom)))(
                  r,
                  a,
                  s,
                )
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    Mx(e) &&
                    !(Ix(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
      ...
      (((e) => {
        ...
        (((e) => {
          ...
          Kc(e) ||
            ((t.body.spellcheck = !1), wB.setAttrib(n, "spellcheck", "false")),
          (e.quirks = CB(e)),
          ((e) => {
            ...
            ((e, t, n) => {
              ...
              if (((n = dn.trim(n)), o && -1 === dn.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = gi.translate([
                      "Failed to initialize plugin: {0}",
                      t,
                    ]);
                    (hd(e, "PluginLoadError", { message: o }),
                      VE(o, n),
                      jE(e, o));
                  })(e, n, t);
                }
    ...
    ZB = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: XB(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = YB(["mobile"], Ie(a, r)),
        l = dn.extend(
          n,
    ...
    tP = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        ow(e, {
          ...
          const n = ((e, t, n) => hE(e).editor.insertContent(t, n))(
            e,
            t.content,
            o,
          );
          ...
          ((e, t, n) =>
            Rr(
              ...
              (t) =>
                ((t) =>
                  jo(t, e).orThunk(() =>
                    oP(t) ? xe(nP, e).bind((e) => yo(t, e)) : I.none(),
                  ))(t),
              (e) => vn(mn.fromDom(t), e),
            ))(e, t, n.dom).or(
            ((e, t) => I.from(li.DOM.getStyle(t, e, !0)))(e, n.dom),
          ),
        )
        .getOr(""),
    sP = rP("font-size"),
    ...
    dP = (e, t) => {
      if (/^[0-9.]+$/.test(t)) {
        ...
        if (n >= 1 && n <= 7) {
          const o = ((e) =>
              dn.explode(e.options.get("font_size_style_values")))(e),
          ...
          (((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = dP(e, t);
                  (e.formatter.toggle("fontname", { value: cP(n) }),
                    e.nodeChanged());
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  (e.formatter.toggle("fontsize", { value: dP(e, t) }),
                    e.nodeChanged());
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        (e.inline ||
                          (rn.browser.isOpera() || Ag(n), e.getWin().focus()),
                          (rn.browser.isFirefox() || e.inline) &&
                            (Ag(n), Rg(e, o)),
                          Og(e));
                      })(e));
              })(e, !0 === o);
  ...
  class hP {
    ...
    execCommand(e, t = !1, n, o) {
      ...
      return (
        !!w(i) &&
        (i(s, t, n, o),
        r.dispatch("ExecCommand", { command: e, ui: t, value: n, args: o }),
        !0)
      );
    }
    queryCommandState(e) {
      if ((!pP(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
    ...
    addCommand(e, t, n) {
      ...
      this.commands.exec[o] = (e, o, r, s) =>
        t.call(null != n ? n : this.editor, o, r, s);
    }
  ...
  const xP = (e, t) => {
      ...
      const n = gc(e);
      return n
        ? (e.eventRoot || (e.eventRoot = wP.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    SP = (e, t, n) => {
      ((e) => !e.hidden && !ix(e))(e)
        ...
        : ix(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !Bg.metaKeyPressed(t)) {
              ...
              ((e, t) =>
                dr(t, "a", (t) => vn(t, mn.fromDom(e.getBody()))).bind((e) =>
                  yo(e, "href"),
                ))(e, n).each((n) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(xP(n, e), e, n.delegates[e]),
  ...
  class zP {
    ...
    createShortcut(e, t, n, o) {
      ...
      return (
        (r[r.length - 1] = dn.extend(r[r.length - 1], {
          func: n,
          scope: o || this.editor,
        })),
        dn.extend(r[0], {
  ...
  class qP {
    constructor(e, t, n) {
        ...
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return AP(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  RP(`Invalid value passed for the ${e} option`, o),
                ),
                !1);
          },
          a = (e) => Se(o, e);
            ...
            const a = ((e) => u(e.processor))(n)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    RP(`Invalid default value passed for the "${e}" option`, o),
                  );
                }
              })(e, n.default, a);
      ...
      const l = ec(o);
      (l &&
        (ci.ScriptLoader._setReferrerPolicy(l),
        li.DOM.styleSheetLoader._setReferrerPolicy(l)),
      ...
      ((e) => {
        ...
        (e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            ea.forElement(e, { contentCssCors: Lc(t), referrerPolicy: ec(t) }))(
            o,
            e,
          )),
          kc(e)
    ...
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : ($P.hide(e.getContainer()),
            $P.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    load(e = {}) {
      ...
      if (!t.removed && n) {
        ...
        (t.setContent(r, o),
          o.no_events || t.dispatch("LoadContent", { ...o, element: n }));
      }
    }
    save(e = {}) {
      const t = this;
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || $P.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = $P.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
  ...
  const QP = (e) => {
    ...
    JP = (e) => {
      ...
      return (
        (XP = Y(XP, (t) => e !== t)),
        tL.activeEditor === e &&
          (tL.activeEditor = XP.length > 0 ? XP[0] : null),
    ...
    tL = {
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (JP(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === XP.length &&
                    window.removeEventListener("beforeunload", YP),
                  n.remove(),
                  ZP(XP.length > 0),
                  n)
            );
      ...
      _setBaseUrl(e) {
        ((this.baseURL = new PC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ""),
        )),
