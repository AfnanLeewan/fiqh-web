!(function () {
  ...
  const $ = O.DOM,
    ...
    z = (e, t) => {
      let r = {};
      for (
        let o = S({ validate: !1, forced_root_block: !1 }, t).parse(e);
        o;
        o = o.walk()
      )
        if (1 === o.type) {
  ...
  const N = (e, t = {}) =>
    ...
    W = (e, t) => {
      ...
      if (
        ...
        (A.extend(
          o,
          z(null !== (r = o.embed) && void 0 !== r ? r : "", e.schema),
        ),
        !o.source)
      )
        return "";
      ...
      const r =
        ...
        a = ((e, t, r) => (a) => {
          const s = () => h(e, a),
            i = () => h(t, a),
            l = (e) =>
              h(e, "value").bind((e) => (e.length > 0 ? n.some(e) : n.none()));
          return {
            [a]: (a === r
              ? s().bind((e) =>
                  o(e) ? l(e).orThunk(i) : i().orThunk(() => n.from(e)),
                )
            ...
            switch (o.name) {
              case "source":
                ((t, r) => {
                  ...
                  t.source !== o.source &&
                    (Z(u, e)({ url: o.source, html: "" }),
                    K(e, o).then(Z(u, e)).catch(Y(e)));
                })(r.get(), t);
                break;
              case "embed":
                ((t) => {
  ...
  const se = (e) => {
    ...
    de = (e) => {
      let t = e;
      for (; (t = t.parent); )
        if (t.attr("data-ephox-embed-iri") || ue(t)) return !0;
      return !1;
    },
    he = (e, t, r) => {
